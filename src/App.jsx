...
// console.log(products);
  return (
    <BrowserRouter >
       <Layout><Header  isLogged={isLogged} setIsLogged={setIsLogged} wishList={wishList} /></Layout>
       <div className='home__img '>

        {/* <img src="../public/bg-img.png  " className='bg-cover ' alt="" /> */}
        </div>
      <Layout>
        ...
        <Routes>
          ...
          />
           <Route path="/product/:productID" element={<SingleProduct   products={products}/>} />
